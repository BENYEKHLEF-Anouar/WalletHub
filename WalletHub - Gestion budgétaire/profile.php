...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            // header("Refresh: 2; Location: " . $_SERVER['PHP_SELF']);
    ...
    <div class="app-container">
        ...
        <aside class="sidebar">
            ...
            <nav class="nav-items">
                ...
                <a href="logout.php" class="nav-item" title="Déconnexion" onclick="return confirm(' Voulez vous vraiment vous déconnecter ?')"><i class="fa-solid fa-sign-out-alt"></i></a>
            </nav>
        </aside>
        ...
        <div class="main-content" data-aos="fade-right" data-aos-duration="1600">
            ...
            <?php if (isset($errors['general'])): ?>
                <p class="error"><i class="fa-solid fa-circle-exclamation"></i> <?= htmlspecialchars($errors['general']) ?></p>
            <?php endif; ?>

            <section class="dashboard-section" data-aos="fade-up" data-aos-delay="100">
                <h2><i class="fa-solid fa-user-edit"></i> Informations personnelles</h2>
                <form method="post" action="">
                    <div class="input-group">
                        ...
                        <?php if (isset($errors['nom'])): ?>
                            <span class="error"><i class="fa-solid fa-circle-exclamation"></i> <?= htmlspecialchars($errors['nom']) ?></span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <?php if (isset($errors['email'])): ?>
                            <span class="error"><i class="fa-solid fa-circle-exclamation"></i> <?= htmlspecialchars($errors['email']) ?></span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <?php if (isset($errors['current_password'])): ?>
                            <span class="error"><i class="fa-solid fa-circle-exclamation"></i> <?= htmlspecialchars($errors['current_password']) ?></span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <?php if (isset($errors['new_password'])): ?>
                            <span class="error"><i class="fa-solid fa-circle-exclamation"></i> <?= htmlspecialchars($errors['new_password']) ?></span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <?php if (isset($errors['confirm_password'])): ?>
                            <span class="error"><i class="fa-solid fa-circle-exclamation"></i> <?= htmlspecialchars($errors['confirm_password']) ?></span>
                        <?php endif; ?>
                    </div>

                    <input type="submit" value="Mettre à jour le profil" onclick="return confirm('Voulez-vous vraiment mettre à jour votre profil ?')">

                </form>
            </section>

            <div class="action-buttons">
                <a href="home.php" class="btn primary"><i class="fa-solid fa-home"></i> Retour à l'accueil</a>
            </div>
        </div>
    </div>
